...
namespace FSComm.ViewModel
{
    public class SerialDeviceViewModel : BaseViewModel
    {
        ...
        public SerialDeviceViewModel(MainWindowViewModel app) : base()
        {
            this.MainWindowViewModel = app;
        ...
        public void InitPorts()
        {
            ...
            {
                if (this.MainWindowViewModel.AppSettingsViewModel.IgnoredSerialPorts.Contains(pname) == false)
                {
        ...
        private void Process(string port, string data)
        {
            ...
            {
                this.MainWindowViewModel.LogViewModel.Add($"Serial Port Received: {data}\n");
                //this.MainWindowViewModel.MQTTClientViewModel.SendSerialData(data);
                this.MainWindowViewModel.HTTPServerViewModel.SendSerialData(data);
            }
