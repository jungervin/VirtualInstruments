...
class RoadNetworkNode {
    constructor(lat, long, epsilon = 0.01) {
    ...
    compare(other) {
        ...
        else if (Math.abs(this.long - other.long) < this.epsilon) {
...
class RoadNetworkLODedData {
    constructor(epsilon, _log = false) {
        ...
        this._tmpNode1 = new RoadNetworkNode(0, 0, this.epsilon);
        this._tmpNode2 = new RoadNetworkNode(0, 0, this.epsilon);
...
class SvgRoadNetworkElement extends SvgMapElement {
    ...
    updateDraw(map) {
        ...
        if (this._iterator >= l) {
            ...
            if (this._hasNewRoads || diffLastLat > thresholdLat || diffLastLong > thresholdLong || Math.abs(this._forcedDirection - map.mapUpDirection) > 2) {
                this._iterator = 0;
